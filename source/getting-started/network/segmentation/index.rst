...
.. hint:: Inhalt
   ...
   * Allgemeiner Teil 
     ...
     * Vorbereitende Massnahmen der Infrastruktur
...
+--------------------------------------------------------------------+-------------------------------------------+
| Segmentierung mit Proxmox                                          | |follow_me2net-config-proxmox|            |
+--------------------------------------------------------------------+-------------------------------------------+
| Segmentierung mit KVM oder XCP-ng                                  | |follow_me2net-config-kvm-xcp-ng|         |
+--------------------------------------------------------------------+-------------------------------------------+
