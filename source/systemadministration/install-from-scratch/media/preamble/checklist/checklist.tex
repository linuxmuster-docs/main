...
Download des IPFires in Version 103 &
\CheckBox[name=downloaded-server,width=1em,height=0.8em,bordercolor={0.65 0.79 0.94}]{}\\
Download des Ubuntu-Servers (ubuntu-12.04.5-server-amd64) &
\CheckBox[name=downloaded-ipfire,width=1em,height=0.8em,bordercolor={0.65 0.79 0.94}]{}\\
\multicolumn{2}{c}{}\\
