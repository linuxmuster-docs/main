...
project = u'linuxmuster.net Linuxclients'
copyright = u'2015, Tobias Küchel'
...
html_title = "Linux-Arbeitsstationen integrieren"
...
latex_documents = [
  ('index', 'linuxclients.tex', u'linuxmuster.net Linuxclients',
   u'Tobias Küchel', 'manual'),
]
