...
Installieren der linuxmuster.net-Musterlösung in der Version 7.1 auf
...
4. Neue VMs werden vorbereitet, um Firewall und Server hier zu installieren (from scratch)
...
.. hint::
   ...
   den Schulserver *server*. KVM ist auf Virtualisierungsfunktionen der CPU angewiesen. Diese
   müssen im BIOS vorab aktiviert worden sein.

Die folgende Anleitung beschreibt die *einfachste* Implementierung ohne Dinge wie VLANs, Teaming/Bonding oder RAIDs. Diese Themen werden
