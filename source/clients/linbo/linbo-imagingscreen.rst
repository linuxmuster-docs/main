...
.. warning:: Vergibt man einen neuen Dateinamen, sollte man sicher stellen, dass die Cache-Partition über ausreichend Platz verfügt. Ist nicht genügend Platz  vorhanden, dann schlägt das Erstellen des Abbildes fehl.
