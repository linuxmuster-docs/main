...
Hast Du alle Vorarbeiten wie im Kapitel :ref:`install-linux-clients-current-label` ausgeführt, startetst Du nun den PC/die VM von CD/DVD/USB-Stick mit Pop!_OS.
...
.. figure:: media/popos/client-install-16.png
   :align: center
   :alt: Pop!_OS Partition einhängen
...
Klickst Du hier auf die Reiterkarte ``Abbiler``, wird das soeben erstellte Image angezeigt.
