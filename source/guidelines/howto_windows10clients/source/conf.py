...
project = u'Windows 10 Clients in linuxmuster.net'
copyright = u'2015, linuxmuster.net e.V. '
...
html_title = "Windows 10 Clients in linuxmuster.net"
...
htmlhelp_basename = 'windwos10client'
...
latex_documents = [
  ('index', 'windows10clients.tex', u'Windows 10 Clients in linuxmuster.net',
   u'linuxmuster.net e.V.', 'manual'),
]
